...
const _privilegeMap = new Map([
	...
	// Follow-up privileges (temporary hard-coded labels)
	['topics:followup', { label: 'Request follow-up', type: 'posting' }],
	['topics:resolveFollowup', { label: 'Resolve follow-up', type: 'moderation' }],
